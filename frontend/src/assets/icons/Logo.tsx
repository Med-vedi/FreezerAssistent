...
const Logo = ({ height = 30 }) => {
	...
	L381.1,421.1z"/>
            <polygon style={{ fill: "#C7C9C9", stroke: "#EDEDED", strokeWidth: "0.995", strokeMiterlimit: "10" }} points="372.6,417.4 305.1,402.1
	...
	c0.2,0,0.4,0.2,0.4,0.4V299.9z"/>
            ...
            <path style={{ fill: "#48A1AF" }} d="M329.3,300.2c0,0.1,0,0.1-0.1,0.1h-6.7c-0.1,0-0.1,0-0.1-0.1v-0.2c0-0.1,0-0.1,0.1-0.1h6.7
